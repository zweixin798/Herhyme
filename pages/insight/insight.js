...
Page({
  data: { logs: [], counts: { diet: 0, training: 0, mood: 0, cycle: 0 }, insightText: '记录得越真实，越容易看见自己的规律。' },
